...
public:
     ...
     */
    friend std::ostream& operator<< (std::ostream& so, const CString& s);
    friend std::istream& operator>> (std::istream& so, CString& s);
    //@}
    ...
    friend bool operator== (const CString& lhs, char          rhs);
    friend bool operator== (const CString& lhs, const char* rhs);
    friend bool operator== (char          lhs, const CString& rhs);
